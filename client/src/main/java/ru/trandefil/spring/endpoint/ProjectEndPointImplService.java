 ...
 * 2019-04-02T12:10:24.705+03:00
 * Generated source version: 3.0.4
 * 
 */
@WebServiceClient(name = "ProjectEndPointImplService", 
                  wsdlLocation = "http://localhost:8080/server/services/projectEndPoint?wsdl",
...
public class ProjectEndPointImplService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/server/services/projectEndPoint?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ProjectEndPointImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/server/services/projectEndPoint?wsdl");
        }
        WSDL_LOCATION = url;
    }
