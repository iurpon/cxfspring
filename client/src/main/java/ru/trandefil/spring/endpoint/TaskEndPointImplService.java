...
@WebServiceClient(name = "TaskEndPointImplService", 
                  wsdlLocation = "http://localhost:8080/server/services/taskEndPoint?wsdl",
...
public class TaskEndPointImplService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/server/services/taskEndPoint?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(TaskEndPointImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/server/services/taskEndPoint?wsdl");
        }
        WSDL_LOCATION = url;
    }
