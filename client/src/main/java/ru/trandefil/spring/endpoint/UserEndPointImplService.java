 ...
 * 2019-04-01T16:46:18.371+03:00
 * Generated source version: 3.0.4
 * 
 */
@WebServiceClient(name = "UserEndPointImplService", 
                  wsdlLocation = "http://localhost:8080/server/services/userEndPoint?wsdl",
...
public class UserEndPointImplService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/server/services/userEndPoint?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UserEndPointImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/server/services/userEndPoint?wsdl");
        }
        WSDL_LOCATION = url;
    }
