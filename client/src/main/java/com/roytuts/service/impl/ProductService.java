 ...
 * 2019-04-01T11:54:50.087+03:00
 * Generated source version: 3.0.4
 * 
 */
@WebServiceClient(name = "productService", 
                  wsdlLocation = "http://localhost:8080/server/services/productService?wsdl",
                  targetNamespace = "http://impl.service.spring.com/")
public class ProductService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://impl.service.spring.com/", "productService");
    public final static QName ProductServiceImplPort = new QName("http://impl.service.spring.com/", "ProductServiceImplPort");
    static {
        URL url = null;
        try {
